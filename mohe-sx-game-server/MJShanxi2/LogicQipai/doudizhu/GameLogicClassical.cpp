...
//扑克数据
const BYTE	CGameLogicClassical::m_cbCardData[FULL_COUNT]=
{
...
//构造函数
CGameLogicClassical::CGameLogicClassical()
{
}
...
//获取类型
BYTE CGameLogicClassical::GetCardType(const BYTE cbCardData[], BYTE cbCardCount)
{
	//简单牌型
	switch (cbCardCount)
	{
...
//排列扑克
VOID CGameLogicClassical::SortCardList(BYTE cbCardData[], BYTE cbCardCount, BYTE cbSortType)
{
	//数目过虑
...
//混乱扑克
VOID CGameLogicClassical::RandCardList(BYTE cbCardBuffer[], BYTE cbBufferCount)
{
	//混乱准备
...
//删除扑克
bool CGameLogicClassical::RemoveCardList(const BYTE cbRemoveCard[], BYTE cbRemoveCount, BYTE cbCardData[], BYTE cbCardCount)
{
	//检验数据
...
//删除扑克
bool CGameLogicClassical::RemoveCard(const BYTE cbRemoveCard[], BYTE cbRemoveCount, BYTE cbCardData[], BYTE cbCardCount)
{
	//检验数据
...
//排列扑克
VOID CGameLogicClassical::SortOutCardList(BYTE cbCardData[], BYTE cbCardCount)
{
	//获取牌型
...
//逻辑数值
BYTE CGameLogicClassical::GetCardLogicValue(BYTE cbCardData)
{
	//扑克属性
...
//对比扑克
bool CGameLogicClassical::CompareCard(const BYTE cbFirstCard[], const BYTE cbNextCard[], BYTE cbFirstCount, BYTE cbNextCount)
{
	//获取类型
...
//构造扑克
BYTE CGameLogicClassical::MakeCardData(BYTE cbValueIndex, BYTE cbColorIndex)
{
	return (cbColorIndex<<4)|(cbValueIndex+1);
}

//分析扑克
VOID CGameLogicClassical::AnalysebCardData(const BYTE cbCardData[], BYTE cbCardCount, tagAnalyseResult & AnalyseResult)
{
	//设置结果
...
//分析分布
VOID CGameLogicClassical::AnalysebDistributing(const BYTE cbCardData[], BYTE cbCardCount, tagDistributing & Distributing)
{
	//设置变量
...
//出牌搜索
BYTE CGameLogicClassical::SearchOutCard( const BYTE cbHandCardData[], BYTE cbHandCardCount, const BYTE cbTurnCardData[], BYTE cbTurnCardCount,
...
//同牌搜索
BYTE CGameLogicClassical::SearchSameCard( const BYTE cbHandCardData[], BYTE cbHandCardCount, BYTE cbReferCard, BYTE cbSameCardCount,
								tagSearchCardResult *pSearchCardResult )
{
	//设置结果
...
//带牌类型搜索(三带一，四带一等)
BYTE CGameLogicClassical::SearchTakeCardType( const BYTE cbHandCardData[], BYTE cbHandCardCount, BYTE cbReferCard, BYTE cbSameCount, BYTE cbTakeCardCount,
									tagSearchCardResult *pSearchCardResult )
{
	//设置结果
	if( pSearchCardResult )
...
//连牌搜索
BYTE CGameLogicClassical::SearchLineCardType( const BYTE cbHandCardData[], BYTE cbHandCardCount, BYTE cbReferCard, BYTE cbBlockCount, BYTE cbLineCount,
									tagSearchCardResult *pSearchCardResult )
{
	//设置结果
	if( pSearchCardResult )
...
//搜索飞机
BYTE CGameLogicClassical::SearchThreeTwoLine( const BYTE cbHandCardData[], BYTE cbHandCardCount, tagSearchCardResult *pSearchCardResult )
{
	//设置结果
	if( pSearchCardResult )
		ZeroMemory(pSearchCardResult,sizeof(tagSearchCardResult));
...
bool  CGameLogicClassical::HaveSpecCard(const BYTE a_cbCardData[], BYTE cbCardCount)
{
	...
	{
		if (GetCardValue(tempAR.cbCardData[3][0]) == 2)
			return true;
	}
