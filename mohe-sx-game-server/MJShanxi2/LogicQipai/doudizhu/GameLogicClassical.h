#ifndef GAME_LOGIC_CLASSICAL_HEAD_FILE
#define GAME_LOGIC_CLASSICAL_HEAD_FILE
...
//分析结构
	...
	public:
		...
		bool  HaveSpecCard(const BYTE a_cbCardData[], BYTE cbCardCount);
