...
public:
	...
	//处理玩家登陆的消息
	void			HanderDeskUserLogin(User* pUser, Lint gateId, Lstring& ip, Lstring uuid, bool firstLogin = false, Lstring buyInfo = "", Lint hide = 0);
	...
	void              handerLMGAPIDisMissRoom(LMsgLMG2LAPIDissmissRoom*msg);
	...
	void            HanderLMGUpdatePointCoint(LMsgLMG2LUpdatePointCoins* msg);
