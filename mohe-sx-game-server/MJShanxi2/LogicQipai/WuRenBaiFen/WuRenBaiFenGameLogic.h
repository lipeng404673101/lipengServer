#ifndef _WU_REN_BAI_FEN_GAME_LOGIC_H_
#define _WU_REN_BAI_FEN_GAME_LOGIC_H_
...
public:
	...
	/* 判断选对家的牌是否符合要求 */
	bool IsValidFirendCard(int selectCard, int selectScore, bool can_select_main_color = false);
