...
public:
	...
	*/
	virtual bool Init(std::string ipAddress, unsigned short port,int threadCount=2,bool listen=false,bool isHttp=false);
	...
	*/
	virtual void RecvMsgPack(LBuffPtr recv,LSocketPtr s, bool bIsFromInternal) = 0;
